package com.cczu.ratelimiter.alg;
...
public class RateLimitAlg {
    private static final Logger log = LoggerFactory.getLogger(RateLimitAlg.class);
    ...
    private RateLimitAlg(int limit, Stopwatch stopwatch){
        this.limit = limit;
